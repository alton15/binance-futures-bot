...
class TestScalpProfile:
    ...
    def test_scalp_risk_values(self):
        assert SCALP.get_risk("risk_per_trade_pct") == 0.008
        ...
        assert SCALP.get_risk("signal_strength_min") == 0.45
        assert SCALP.get_risk("sl_atr_multiplier") == 3.0
        assert SCALP.get_risk("tp_atr_multiplier") == 3.5
        assert SCALP.get_risk("trailing_stop_pct") == 0.02
    ...
    def test_scalp_signal_values(self):
        ...
        assert SCALP.get_signal("min_strength") == 0.45

    def test_scalp_leverage_range(self):
        assert SCALP.leverage_min == 5
        assert SCALP.leverage_max == 10
